...
- [ ] Todas las corutinas de stream usan `_has_subscribers()` (líneas 1180, 1330, 1533, 1654, 1750, 1842, 1919)
- [ ] No quedan checks `any(channel in c.channels for c in self._connections)` inline fuera del propio helper
- [ ] Comportamiento sin cambios (mismo early-exit)
