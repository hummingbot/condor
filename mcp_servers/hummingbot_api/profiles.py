...
TOOL_DESCRIPTIONS: dict[str, str] = {
    ...
    "create_lending_executor": "Supply or withdraw under an exact lending plan — can spend funds",
    "list_onchain_venues": "Discover Aomi-supported Solana venues",
    "inspect_onchain_market": "Inspect market assets, fees and wallet shares",
    "get_onchain_position": "Read wallet shares in an Aomi-supported venue",
    "prepare_onchain_action": "Prepare unsigned venue instructions without executing",
    "create_onchain_executor": "Preview or execute an Aomi on-chain bundle",
