...
DEFAULTS: Dict[str, Any] = {
    ...
    "buy_cooldown_time": 10,
    "sell_cooldown_time": 10,
...
FIELDS: Dict[str, ControllerField] = {
    ...
    "portfolio_allocation": ControllerField(
        ...
        type="float",
        required=True,
        hint="Fraction of portfolio (e.g. 0.03 = 3%)",
        default=0.03,
    ),
    "target_base_pct": ControllerField(
        ...
        type="float",
        required=True,
        hint="Target base asset percentage (e.g. 0.5 = 50%)",
        default=0.5,
    ),
    "min_base_pct": ControllerField(
        ...
        type="float",
        required=False,
        hint="Minimum base % before buying (default: 0.3)",
        default=0.3,
    ),
    "max_base_pct": ControllerField(
        ...
        type="float",
        required=False,
        hint="Maximum base % before selling (default: 0.7)",
        default=0.7,
    ),
    "buy_spreads": ControllerField(
        ...
        type="str",
        required=True,
        hint="Comma-separated spreads (e.g. 0.0002,0.0006)",
        default="0.0002,0.0006",
    ),
    ...
    "buy_amounts_pct": ControllerField(
        ...
        type="str",
        required=False,
        hint="Comma-separated amounts (e.g. 1,1)",
        default="1,1",
    ),
    ...
    "take_profit": ControllerField(
        ...
        type="float",
        required=True,
        hint="Take profit percentage (e.g. 0.0003 = 0.03%)",
        default=0.0003,
    ),
    ...
    "executor_refresh_time": ControllerField(
        ...
        type="int",
        required=False,
        hint="Executor refresh interval (default: 10)",
        default=10,
    ),
    "buy_cooldown_time": ControllerField(
        ...
        type="int",
        required=False,
        hint="Cooldown between buy orders (default: 10)",
        default=10,
    ),
    "sell_cooldown_time": ControllerField(
        ...
        type="int",
        required=False,
        hint="Cooldown between sell orders (default: 10)",
        default=10,
    ),
    "buy_position_effectivization_time": ControllerField(
        ...
        type="int",
        required=False,
        hint="Time to effectivize buy positions (default: 300)",
        default=300,
    ),
    "sell_position_effectivization_time": ControllerField(
        ...
        type="int",
        required=False,
        hint="Time to effectivize sell positions (default: 300)",
        default=300,
    ),
    "price_distance_tolerance": ControllerField(
        name="price_distance_tolerance",
        label="Price Distance Tolerance",
        type="str",
        required=False,
        hint="Min price distance tolerance (default: 0.0005)",
        default="0.0005",
    ),
    "refresh_tolerance": ControllerField(
        name="refresh_tolerance",
        label="Refresh Tolerance",
        type="str",
        required=False,
        hint="Price change tolerance before refresh (default: 0.0005)",
        default="0.0005",
    ),
    "tolerance_scaling": ControllerField(
        name="tolerance_scaling",
        label="Tolerance Scaling",
        type="str",
        required=False,
        hint="Tolerance scaling factor (default: 1.2)",
        default="1.2",
    ),
    "max_active_executors_by_level": ControllerField(
        ...
        type="int",
        required=False,
        hint="Max active executors per level (default: 10)",
        default=10,
    ),
    ...
    "position_profit_protection": ControllerField(
        name="position_profit_protection",
        label="Position Profit Protection",
        type="bool",
        required=False,
        hint="Protect accumulated position profit",
        default=True,
    ),
    "min_skew": ControllerField(
        name="min_skew",
        label="Min Skew",
        type="str",
        required=False,
        hint="Minimum inventory skew factor (default: 1.0)",
        default="1.0",
    ),
    "global_take_profit": ControllerField(
        name="global_take_profit",
        label="Global Take Profit",
        type="str",
        required=False,
        hint="Global take profit threshold (default: 0.03 = 3%)",
        default="0.03",
    ),
    "global_stop_loss": ControllerField(
        name="global_stop_loss",
        label="Global Stop Loss",
        type="str",
        required=False,
        hint="Global stop loss threshold (default: 0.05 = 5%)",
        default="0.05",
    ),
    "total_amount_quote": ControllerField(
        ...
        type="float",
        required=False,
        hint="Total amount in quote currency (e.g. 1000 USDT)",
        default=1000,
    ),
