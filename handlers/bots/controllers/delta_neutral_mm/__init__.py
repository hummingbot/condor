"""
Delta Neutral Market Making Controller Module

Market making with delta hedging on perpetual exchange.
"""
...
class DeltaNeutralMMController(BaseController):
    controller_type = "delta_neutral_mm"
    display_name = "Delta Neutral Market Making"
    description = "Market making with delta hedging on perpetual exchange"
...
__all__ = ["DeltaNeutralMMController", "DEFAULTS", "FIELDS", "FIELD_ORDER", "EDITABLE_FIELDS",
