...
export function ImportGatewayWallet({
  ...
  const keyLooksValid = chain === "ethereum" ? derived !== null : SOLANA_KEY_RE.test(trimmed);
  ...
  async function handleImport() {
    ...
    try {
      ...
      setImportedAddress(res.address ?? derived ?? "");
      setKey("");
      ...
      {importedAddress !== null ? (
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs text-[var(--color-text-muted)]">
            The key is sent to your Hummingbot API server and stored encrypted by the Gateway. It is
            never persisted by this dashboard.
          </p>
