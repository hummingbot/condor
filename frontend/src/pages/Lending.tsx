...
function LendingForm({ server }: { server: string }) {
  ...
  return <div className="max-w-5xl mx-auto p-6 space-y-6">
    <Link to="/executors" className="text-sm text-[var(--color-text-muted)]">← Executors</Link>
    ...
    <div className="grid gap-6 lg:grid-cols-2">
      ...
      <div className="space-y-4">
        ...
        {detail.isError && <p role="alert" className="text-sm">Could not refresh this executor. <Link to="/executors" className="underline">Check Executors</Link> before submitting again.</p>}
