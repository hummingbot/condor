---
name: routine_async_patterns
description: 'Async patterns for routines: gather for parallel calls, Semaphore for
  bulk rate limiting, safe error handling'
when_to_use: When a routine needs to fetch data for multiple pairs, markets, or resources
  simultaneously — or when doing 4+ independent API calls that can run in parallel.
created: '2026-06-30T08:53:54Z'
source: chat
---
