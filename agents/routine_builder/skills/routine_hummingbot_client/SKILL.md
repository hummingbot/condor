---
name: routine_hummingbot_client
description: 'Hummingbot client API patterns for routines: market data, candles, order
  book, portfolio, executors'
when_to_use: When writing a routine that needs to fetch market data, candles, prices,
  order book, funding rates, portfolio balances, or executor performance from a Hummingbot
  server.
created: '2026-06-30T08:53:45Z'
source: chat
---
