...
### Pre-flight
Before deploying or resuming this strategy, read the regime for SNDK-USDT and adjust the
spreads below to match it:
- 14d candles — realised volatility and whether price is ranging or trending
- Order book snapshot — depth at the quoted levels, and how far the top of book sits from mid
- Funding rate — a persistent sign biases the sell-side skew

Classify into one of the three regimes in **Regime Adaptation** and apply its spreads before
starting the bot.
